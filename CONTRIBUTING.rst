...
Welcome to ``GenomicRanges`` contributor's guide.
...
If you experience bugs or general issues with ``GenomicRanges``, please have a look
...
You can help improve ``GenomicRanges`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``GenomicRanges`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``GenomicRanges``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n GenomicRanges python=3 six virtualenv pytest pytest-cov
    conda activate GenomicRanges
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/GenomicRanges.git
    cd GenomicRanges
...
#. Install |pre-commit|_::
   ...
   ``GenomicRanges`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/GenomicRanges
.. _issue tracker: https://github.com/<USERNAME>/GenomicRanges/issues
.. <-- end -->
