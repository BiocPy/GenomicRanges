...
`GenomicRanges` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/GenomicRanges
[issue tracker]: https://github.com/<USERNAME>/GenomicRanges/issues
